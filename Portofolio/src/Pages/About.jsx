        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I’m a Bachelors of Science in Computer Science graduate passionate
              about full stack development. I focus on creating engaging, modern
              digital experiences and always aim to deliver the best solutions
              in every project I work on. Currently exploring the MERN stack and
              modern web technologies, I’m committed to continuous learning and
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="/Neeraj_Gupta.pdf" download className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
